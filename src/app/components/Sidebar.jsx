...
export default function Sidebar() {
  return (
    <div className="hidden sm:flex flex-col gap-3 sm:items-start fixed ml-3 w-[280px]">
      ...
      <div className="hoverEffect text-gray-700 flex items-center space-x-3 justify-center xl:justify-start mt-auto bottom-3 fixed w-full">
        <img
